<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JoinUs.ascx.cs" Inherits="LINQdIn.CustomControls.JoinUsControl.JoinUs" %>
<%@ OutputCache Duration="300" VaryByParam="None" %>
 ...
 <div class="jumbotron">
     ...
     <p>We already have <span id="usersCount" runat="server"></span> users to connect with!</p>
    </div>